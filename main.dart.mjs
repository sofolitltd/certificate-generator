...
_1653: d => stringToDartString(d.toExponential()),
_1654: (d, f) => stringToDartString(d.toExponential(f)),
...
_1800: (x0,x1) => x0.getRandomValues(x1),
_1801: x0 => new Uint8Array(x0),
_1802: () => globalThis.crypto,
